    ...
    try:
        ...
        for stat in difficulty_stats:
            difficulty_distribution.append({
                ...
                "count": stat.count,
                "percentage": round((stat.count / total_problems * 100), 1),
        ...
        return {
            "overview": {
                ...
                "coverage_score": round((high_relevance_count / total_problems * 100), 2)
            },
    ...
    try:
        ...
        for difficulty in ['Easy', 'Medium', 'Hard']:
            ...
            calibration_analysis.append({
                ...
                "avg_rating": round(stats.avg_rating or 0, 0),
                "rating_range": {
                    "min": round(stats.min_rating or 0, 0),
                    "max": round(stats.max_rating or 0, 0)
                },
    ...
    try:
        ...
        return {
            "overview": {
                ...
                "readiness_score": round((interview_ready_problems.count() / db.query(Problem).count() * 100), 2)
            },
    ...
    try:
        ...
        improvement_summary = {
            ...
            "current_distribution": {
                ...
                "interview_coverage": round((current_high_relevance + current_medium_relevance) / total_problems * 100, 1)
            },
            "quality_metrics": {
